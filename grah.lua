...
local function CreateKeybindSelector(parent, title)
    ...
    -- Create the checkbox (Aimbot enabled or not)
    local checkbox = Instance.new("TextButton")
    checkbox.Name = title .. "Checkbox"
    checkbox.Parent = frame
    checkbox.Size = UDim2.new(0, 25, 0, 25)
    checkbox.Position = UDim2.new(0, 160, 0, 2)
    ...
    keybindLabel.Name = title .. "KeybindLabel"
    keybindLabel.Parent = frame
    keybindLabel.Size = UDim2.new(0, 100, 0, 30)
    keybindLabel.Position = UDim2.new(0, 190, 0, 0)
    keybindLabel.BackgroundTransparency = 1
    keybindLabel.Text = "(None)"
    keybindLabel.TextColor3 = Color3.fromRGB(170, 170, 170)  -- Gray for no keybind
    keybindLabel.TextSize = 16
    keybindLabel.TextXAlignment = Enum.TextXAlignment.Left

    -- Variable to store keybind
    local keybind = nil

    -- Toggle checkbox state when clicked
    checkbox.MouseButton1Click:Connect(function()
        checkbox.Text = checkbox.Text == "✓" and "" or "✓"
        checkbox.BackgroundColor3 = checkbox.Text == "✓" and Color3.fromRGB(0, 255, 0) or Color3.fromRGB(255, 0, 0)
    end)

    -- Allow the user to press a key to set the keybind
    keybindLabel.MouseButton1Click:Connect(function()
        keybindLabel.Text = "Press any key..."
        keybindLabel.TextColor3 = Color3.fromRGB(255, 255, 255)  -- White to show they can set the keybind
